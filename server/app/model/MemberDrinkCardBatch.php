...
/**
 * 会员饮品卡批次，结构与赠金批次对称，按 expired_at 由近及远消耗
 *
 ...
 * @property int $status
 */
class MemberDrinkCardBatch extends BaseModel
{
    public const int SOURCE_ADMIN      = 1;
    public const int SOURCE_REFUND     = 2;
    public const int SOURCE_ORDER_GIFT = 3;

    public const int STATUS_VALID   = 1;
    public const int STATUS_USED_UP = 2;
    public const int STATUS_EXPIRED = 3;

    protected $table = 'nf_member_drink_card_batch';
