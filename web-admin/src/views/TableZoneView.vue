...
const fields: CrudField[] = [
  { prop: 'name', label: '分区名称', required: true, placeholder: '如 一号台 / 二号台' },
...
<template>
  <CrudTable :api="tableZoneApi" :columns="columns" :fields="fields" title="桌号分区" />
</template>
